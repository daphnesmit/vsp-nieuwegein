...
export type HomePageTemplateQuery = (
  { __typename?: 'Query' }
...
export type RecentPageTemplateQuery = (
  { __typename?: 'Query' }
  & { markdownRemark: Maybe<(
    { __typename?: 'MarkdownRemark' }
    & { frontmatter: Maybe<(
    ...
    & { edges: Array<(
      ...
      & { node: (
        ...
        & { frontmatter: Maybe<(
          { __typename?: 'MarkdownRemarkFrontmatter' }
          & Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'templateKey'>
        )> }
      ) }
    )> }
  ) }
...
export type RecentPostByIdQuery = (
  { __typename?: 'Query' }
  & { markdownRemark: Maybe<(
    { __typename?: 'MarkdownRemark' }
